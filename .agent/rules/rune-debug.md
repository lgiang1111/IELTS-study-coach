...
**Why:** Debugging naturally expands scope as you trace root causes. Without a boundary, the rune-fix rule receives recommendations touching 10+ files across unrelated modules. The scope lock forces discipline: fix at the source, not at every symptom site.
